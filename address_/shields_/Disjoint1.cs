...
{
	public class DisjointOfSeq : nilnul.fs.address_.shields.be_.disjoint.vow.EeOfSeq
	{
		public DisjointOfSeq(ShieldsI val) : base(val)
		{
		}

		public DisjointOfSeq(IEnumerable<ShieldI> _disjoint) : this(
			new Shields(_disjoint) as ShieldsI
		)
		{
		}
		public DisjointOfSeq() : this(new Shields())
		{
		}
		...
		public DisjointOfSeq(IEnumerable<string> folders) : this(
		...
		static public DisjointOfSeq FroUnsured(IEnumerable<ShieldI> folders)
		{
		...
		static public DisjointOfSeq FroUnsured(IEnumerable<NotNull2<ShieldI>> folders)
		{
			return new DisjointOfSeq(
				ToDisjoin(
					folders
