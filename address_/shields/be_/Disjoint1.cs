...
namespace nilnul.fs.address_.shields.be_
{
	...
	/// </summary>
	static public class _DisjointX1
	{
	...
	public class Disjoint1 : nilnul.fs.address_.shields.BeI1
	{
		...
		{
			return _DisjointX1.Be(obj);
			throw new NotImplementedException();
		}


		static public Disjoint1 Singleton
		{
			get
			{
#pragma warning disable CS0612 // 'Singleton<Disjoint1>' is obsolete
				return nilnul._obj.Singleton<Disjoint1>.Instance;
