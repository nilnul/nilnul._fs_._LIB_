namespace nilnul.fs.file_.link_.sym.create_
{
	/// <summary>
	/// 
	/// </summary>
	static public class _ExtSameX
	{
		public static void Create(
			nilnul.fs.address_.ShieldI linkShield
			,
			nilnul.fs._address.doc_._exted.MainI linkMain
			,
			nilnul.fs.address_.SpearI target
		)
		{
			file_._SymlinkX.Create(linkShield,
				new nilnul.fs._address.doc_.MainExt(linkMain.ToString(), nilnul.fs.address_.spear._DocExtX.Ext(target))
				,
				target
			);
		}
		...
		public static void Create(
			nilnul.fs.address_.ShieldI linkShield
			,
			nilnul.fs._address.doc_._exted.Main linkMain
			,
			nilnul.fs.address_.SpearI target
		)
		{
			file_._SymlinkX.Create(linkShield,
				new nilnul.fs._address.doc_.MainExt(linkMain, nilnul.fs.address_.spear._DocExtX.Ext(target))
				,
				target
			);
		}
		...
		)
		{
			Create(
				linkShield
				,
				new _address.doc_._exted.Main(linkMain)
				,
				target
			);
		}
		...
		{
			Create(nilnul.fs.address_.Shield.FroAddress(linkShield), main, target);
		}
		...
		{
			OfLinkShieldAsAddress(linkShield, main, nilnul.fs.address_.Spear.Parse(target));
		}
	}
	/*
