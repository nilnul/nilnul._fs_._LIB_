...
namespace nilnul.fs.file_.link_.hard.create_.by_.mklink_.sameExt_
{
	/// <summary>
	/// 
	/// </summary>
	static public class _OfLinkAsContainerDivMainX
	{
		...
		public static void Create(
			nilnul.fs.address_.ShieldI1 linkShield
			,
			nilnul.fs._address.DivMain linkDivMain
			, 
			nilnul.fs.address_.SpearI1 target
		) {
			file_.link_.hard.create_.by_._MkLinkX.Exe( 

				new nilnul.fs.address_.spear_.ShieldDocument(
					linkShield
					,
		...
		public static void Ensure(
			...
			file_.link_.hard.create_.by_._MkLinkX.Ensure( 
		...
		public static void OfLinkShieldAsAddress(
			...
			Create(  nilnul.fs.address_.Shield1.FroAddress(linkShield), divMain ,target);
		}
		...
		public static void Ensure_ofLinkAncesterAsAddress(
			...
			Ensure(  nilnul.fs.address_.Shield1.FroAddress(linkShield), divMain ,target);
		}
		...
		public static void OfLinkAncesterAsAddress(
			...
			OfLinkShieldAsAddress(linkShield,divMain, nilnul.fs.address_.Spear1.Parse(target));
		}
		...
		public static void Ensure_ofLinkAncesterAsAddress(
			...
			Ensure_ofLinkAncesterAsAddress(linkShield,divMain, nilnul.fs.address_.Spear1.Parse(target));
		}
