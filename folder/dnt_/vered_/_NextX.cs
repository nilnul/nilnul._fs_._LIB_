...
#pragma warning restore CS0612 // 'Versioned1' is obsolete
		...
		static public nilnul.NumI1 Num(FolderI1 dirInfo, nilnul.fs._address._dst.denote_._vered.Germ prefix)
		{
			return Num(nilnul.fs.folder.op_.to_._InfoX.To(dirInfo), (prefix));
		}
		...
		public static string Name(FolderI1 parent, nilnul.fs._address._dst.denote_._vered.Germ prefix)
		{
			return $"{prefix}{nilnul.txt_.num_.radix_.Dec.Singleton.toTxt_zeroEmpty((int)(Num(parent, prefix).toBigint().en))}";
		}
		...
		static public string Address(nilnul.fs.FolderI1 parent, nilnul.fs._address._dst.denote_._vered.Germ prefix)
		{
			return $"{parent}{Name(parent, prefix)}";
		}
