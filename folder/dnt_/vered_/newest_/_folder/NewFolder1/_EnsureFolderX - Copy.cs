...
namespace nilnul.fs.folder.denote_.vered
{
	...
	public static class _EnsureNewestBeFolderX
	{
		...
		public static nilnul.fs.Folder Folder(nilnul.fs.FolderI container, nilnul.fs._address._dst.denote_.Vered vered)
		{
			return Folder(container, vered.germ);
		}
		public static nilnul.fs.Folder Folder(nilnul.fs.FolderI container, string vered)
		{
			return Folder(container, nilnul.fs._address._dst.denote_._vered_.Germ.CreateByAppendingSubIfNeed(vered));
		}
