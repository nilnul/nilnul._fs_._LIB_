...
namespace nilnul.fs.folder.dirs_.notDotLed_
{
	/// <summary>
	...
	static public class _NonlinkX
	{
		...
		{
			return  nilnul.fs.folder.dirs_._NotDotLedX.Dirs(folder).Where(

				x => nilnul.fs.folder.dir.be_.symlink._AntoX.Be(folder,x)
			);
		}
