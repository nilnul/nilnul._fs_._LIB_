...
namespace nilnul.fs.folder.dir
{
	...
	public class _MoveX
	{
		...
		public static void _Vod(nilnul.fs.FolderI sourceParent, fs._address.DirI sourceDir, nilnul.fs.FolderI _targetParent_Exists)
		{
			var target = new nilnul.fs.address_.shield_.BaseDir(_targetParent_Exists.address.en,sourceDir);


			var src =new nilnul.fs.address_.shield_.BaseDir(sourceParent.address.en, sourceDir);
