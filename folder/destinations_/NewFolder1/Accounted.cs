...
namespace nilnul.fs.folder.destinations_
{
	...
	static public class _AccountedX
	{
		...
		static public IEnumerable<DestinationI> Destinations(nilnul.fs.FolderI folder, _address.DocI ignoreDoc=null) {
			...
			return nilnul.fs.folder.dsts_._AccountedX.Dsts(folder,ignoreDoc).SelectMany(
				d => {
					switch (d)
					{
						...
						case _address.DirI dir:
							return 
							  nilnul.fs.folder.divisions_._Self0accountedX.Divisions(
